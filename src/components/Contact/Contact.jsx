...
const socialLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/Aditya Mishra-R-official',
        icon: <Github />,
        color: 'primary'
    },
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/Aditya Mishra-r-7b9197258/',
        icon: <LinkedIn />,
        color: 'secondary'
    },
    {
        name: 'Email',
        url: 'mailto:developersinthehouse.gmail.com',
        icon: <Mail />,
        color: 'accent'
    },
]
                    ...
                    >
                        ...
                        <div className={styles.contactDetails}>
                            <div className={styles.detailItem}>
                                <Mail />
                                <a href="mailto:developersinthehouse.gmail.com">
                                    developersinthehouse.gmail.com
                                </a>
                            </div>
                        </div>
